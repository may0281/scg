		...
		if ($.validator) {
			$('.login-form').validate({
				...
				submitHandler: function (form) {
					...
					var start_lang = document.getElementById('start_lang').value;
					
					if(usname==''){
						document.getElementById('w-username').style.display = "block";
					}else{
						document.getElementById('w-username').style.display = "none";
					}

					if(passw==''){
						document.getElementById('w-password').style.display = "block";
					}else{
						document.getElementById('w-password').style.display = "none";
					}

					if(usname!='' && pass!=''){
						window.location.href = "login/checklogin";
					}
				}
			});
		}
