...
class part extends CI_Controller
{
	...
	{
		$data['q'] = $this->service_model->SelectByType('part');
        $data['gallery'] = $this->service_model->SelectGallery(2);
        $data['type'] = 'part';
    ...
    public function edit()
    {
        ...
        echo "<script>alert('Success!!');window.location.assign('".base_url()."part');</script>";
