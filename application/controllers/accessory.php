...
class accessory extends CI_Controller
{
	...
	{
		$data['q'] = $this->service_model->SelectByType('accessory');
        $data['gallery'] = $this->service_model->SelectGallery(4);
        $data['type'] = 'accessory';
    ...
    public function edit()
    {
        ...
        echo "<script>alert('Success!!');window.location.assign('".base_url()."accessory');</script>";
