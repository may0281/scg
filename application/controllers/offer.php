...
class offer extends CI_Controller
{
	...
	{
		$data['q'] = $this->service_model->SelectByType('offer');
        $data['gallery'] = $this->service_model->SelectGallery(3);
        $data['type'] = 'offer';
    ...
    public function edit()
    {
        ...
        echo "<script>alert('Success!!');window.location.assign('".base_url()."offer');</script>";
