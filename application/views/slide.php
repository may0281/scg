			...
			<div class="container">
				...
				<div class="crumbs">
					...
					<ul class="crumb-buttons">
						<li><a href="<?php echo base_url(); ?>slide/Add" title=""><i class="icon-plus"></i><span>ADD Slide</span></a></li>
								...
								<table class="table table-striped table-bordered table-hover table-checkable datatable" data-display-length="30">
									...
									<tbody>
										...
										<tr>
											...
											<td><img src='<?php echo $domain[0]."images/slide/".$r['image'];?>' width="150"> <br> <?php echo $r['image'];?> </td>
											<td><?php echo $r['url'];?></td>
											<td><?php echo $r['special_txt_1'];?>
                                                <?php echo $r['special_txt_2'];?>
                                                <?php echo $r['special_txt_3'];?>
                                                <?php echo $r['special_txt_4'];?>
                                                <?php echo $r['special_txt_5'];?>
                                            </td>
											<td data-hide="phone,tablet"><a href="<?php echo base_url(); ?>slide/edit/<?php echo $r['id']; ?>" title="Edit slide">Edit </a></td>
											<td data-hide="phone,tablet"><a href="<?php echo base_url(); ?>slide/del/<?php echo $r['id']; ?>" title="Edit slide">Del </a></td>
										</tr>
										<?php $i++; }?>
									</tbody>
								</table>
